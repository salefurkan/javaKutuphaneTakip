...
public class LoginFE extends JDialog implements IFeInterfaces {
	...
	public static JComboBox personelBox; // statik deðiþken kullanýmý sayesinde personelin girdiði 
	...
	public JPanel initPanel() {
		...
		PersonelContract yapýcýContract = new PersonelContract();
		personelBox.setSelectedIndex(yapýcýContract.getId());    /// YAPICI KULLANIMI
